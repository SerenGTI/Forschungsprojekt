...
The size of a graph is defined as the number of edges $|E|$\todo{citation?}.
...
\subsection{PageRank}
\emph{PageRank} (PR) is a link analysis algorithm that weighs the vertices of a graph, measuring the vertices relative importance within the graph \cite{pagerank}. This represents a centrality metric of the vertices.
