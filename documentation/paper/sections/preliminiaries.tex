...
In general such an operator can change the structure of the \emph{neighbourhood} too.
...
A \emph{push-style} operator reads the value of the \emph{active} vertex or edge and updates the values of its \emph{neighborhood}.
