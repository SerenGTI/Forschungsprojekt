...
\end{figure}
For both the calculation and the execution times, Breadth-First Search shows similar behaviour as the distributed SSSP test case. All measurements can be seen in \autoref{fig:distributedBFS}.
